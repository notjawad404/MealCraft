...
const recipeSchema = mongoose.Schema({
    ...
    // A much smaller re-encoding of `image`, generated by the client at upload
    // time. Listings return this and omit `image` entirely, so a page of twenty
    // recipes costs kilobytes rather than tens of megabytes.
    thumbnail:{
        type: String,
    },
    username:{
